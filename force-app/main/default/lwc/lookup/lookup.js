...
// EXPOSED FUNCTIONS
    ...
    setSearchResults(results) {
        this.searchResults = results.map(result => result.id);
        console.log('searchresultsstring');
        console.log(JSON.stringify(this.searchResults, null, '\t'));
        this.template.querySelector('c-accdatatable').controlTableOn();
    }
...
// INTERNAL FUNCTIONS
    ...
    updateSearchTerm(newSearchTerm) {
        ...
        if (newCleanSearchTerm.length < MINIMAL_SEARCH_TERM_LENGTH){
            this.template.querySelector('c-accdatatable').controlTableOff();
        }
